...
<!-- VISUAL:05-A -->
![GEO 的五类关键指标信息图](./img/05_01_核心框架.png)
...
<!-- VISUAL:05-B -->
![GEO 评估的三层证据信息图](./img/05_02_方法详解.png)
...
> **系列导航**：[← 上一篇：品牌在大模型提及率为 0 怎么办？](./04_品牌在大模型提及率为0怎么办_GEO诊断五步法.md) · [返回目录](./README.md) · [下一篇：AnswerBit 如何监控豆包、元宝、DeepSeek、Kimi 和千问 →](./06_AnswerBit如何监控豆包元宝DeepSeek_Kimi和千问.md)
